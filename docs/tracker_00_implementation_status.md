...
| DESIGN-CONV-D | D | Keyboard | First ⌘K on new workspace: inline 3-step ghost inside palette (search → ↵ columns → ⌥↵ rows); dismiss forever | DESIGN-RESET-1 | In review | Yes | T,L,U,I | No coaching reappear on reopen; workspace-scoped localStorage dismiss; ghost matches shipped palette footer grammar |

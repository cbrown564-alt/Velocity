...
| 5 | **Output quality: PowerPoint and spreadsheets** | Editable PPTX/XLSX exports exist, but neither format has been benchmarked against a traceable set of strong market research outputs. The [two-track plan](plan_07_researcher_journey_and_output_quality.md) separates this evidence work from ongoing Canvas improvements; the earlier [deck plan](workstreams/deck_native/07_report_quality_experience_plan_v2.md) provides background for narrative and editable-slide requirements. | Gather real output examples across research publishers, agencies, and tools; inspect current PPTX/XLSX beside them; define one reference slide and one reference sheet before broad exporter styling changes. |

...
| DESIGN-CONV-B | B | Journey | Export preview lane: thumbnail filmstrip of export-bound slides, recipe summary, significance audit — review step before PPTX download | DESIGN-RESET-1 | In review | Yes | T,L,U,I,V | PR https://github.com/cbrown564-alt/Velocity/pull/55 — unit tests (exportPreviewSummary, ExportPreviewLane, ExportModal preview gate); e2e pilot + brand-tracker require preview before PPTX |

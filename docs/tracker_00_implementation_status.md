...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| S4-EVAL-1 | Eval Program | Canonical Phase 4 plan, task portfolio, benchmark contract, scoring model, and capability-gap review structure for agent-led validation of the full app surface | S3-SEM-1 | In review | No | A | `docs/plan_phase4_agent_capability_validation.md`, `docs/eval_00_agent_interface_validation.md`, `docs/eval_00_outcome_decision_framework.md`, `docs/eval_00_capability_gap_review.md`, `docs/eval_00_task_portfolio.md`, `docs/eval_00_benchmark_result_template.md`, `docs/eval_00_phase_synthesis_template.md` |
| S4-EVAL-2 | Workflow Validation | Intended-path readiness: MCP setup reliability, session round-trip clarity, engine/tool contract consistency, workflow docs alignment, artifact capture | S4-EVAL-1 | Not started | Yes | T,L,U,I,A | - |
| S4-EVAL-3 | Eval Execution | Executed task portfolio across discovery, deck authoring, handoff, convergence, harmonization, and stress cases with standardized outputs | S4-EVAL-2 | Not started | No | U,I,A | - |

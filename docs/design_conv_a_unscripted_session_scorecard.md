...
**Purpose:** Score 3–5 unscripted first sessions on the design-reset UI so Path A evidence can decide whether palette discovery and recent/pinned variable reuse work for consultant workflows.
...
- Did the palette open automatically after upload? Record separately from participant discovery.

...
def build_payload():
    ...
    for study in ["SBT-002", "SBT-003", "FSA-CIT-2025-03"]:
        project = (
            BASE
...
def main():
    ...
    root = BASE / "review/2026-09-pilot"

    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Icon */}
          <Icon size={12} strokeWidth={isActive ? 2 : 1.5} className="shrink-0" />
          ...
          {/* Unsaved indicator */}
          {hasUnsavedChanges && <span className="w-1.5 h-1.5 rounded-full bg-[var(--status-warning-text)] shrink-0" />}
        </motion.button>

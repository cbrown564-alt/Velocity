      ...
      <div className={styles.itemContent}>
        ...
        <div style={{ minWidth: 0, flex: 1 }}>
          ...
          {variable.label && variable.label !== variable.name && (
            <div className={styles.itemSubtitle}>{variable.name}</div>
          )}
        </div>
      </div>
...
export const VariableColumn: React.FC = () => {
  ...
  if (!shouldShow) {
    return <div className={`${styles.column} ${styles.col4} ${styles.columnHidden}`} />;
  }
  ...
  return (
    <div className={`${styles.column} ${styles.col4}`}>
      <div className={styles.columnHeader}>
        ...
        <span style={{ fontSize: 'var(--text-xs)', color: 'var(--text-tertiary)' }}>{variables.length}</span>
      </div>

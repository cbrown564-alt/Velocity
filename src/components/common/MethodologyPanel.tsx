...
function computePopoverCoords(anchor: HTMLElement): PopoverCoords {
  ...
  const placement = spaceBelow < POPOVER_MAX_HEIGHT * 0.6 && spaceAbove > spaceBelow ? 'above' : 'below';
  ...
  switch (id) {
    case 'cell-vs-rest':
      return (
        <div className="space-y-2 text-[var(--text-secondary)] text-xs leading-relaxed">
          <p>
            Each cell is compared to the <strong className="text-[var(--text-primary)]">rest of the table</strong> (all
            other cells combined). Arrows mark cells that are unusually high or low.
          </p>
    ...
    case 'welchs-t':
      return (
        <div className="space-y-2 text-[var(--text-secondary)] text-xs leading-relaxed">
          ...
          <p>
            The t-score is converted to a <strong className="text-[var(--text-primary)]">p-value</strong> for
            significance.
          </p>
        </div>
      );
    case 'ess':
      return (
        <div className="space-y-2 text-[var(--text-secondary)] text-xs leading-relaxed">
          <p>
            With weights, <strong className="text-[var(--text-primary)]">ESS</strong> (Kish) estimates effective sample
            size:
          </p>
          <div className="rounded border border-[var(--border-color)] bg-[var(--bg-active)] px-2.5 py-2 font-mono text-[10px]">
            ESS = (Σw)² / Σw²
      ...
      return (
        <div className="space-y-2 text-[var(--text-secondary)] text-xs leading-relaxed">
          ...
          <p className="text-[10px] text-[var(--text-tertiary)]">
            Report at 95%; use 80% to flag patterns worth validating.
          </p>
        </div>
      );
  }

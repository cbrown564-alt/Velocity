...
describe('DropZone', () => {
  ...
  describe('empty state', () => {
    ...
    it('applies correct sizing for row type', () => {
      const { container } = renderWithDnd(
        <DropZone id="test-zone" type="row" label="Rows" active={false} currentVariables={[]} onRemove={vi.fn()} />,
      );
  ...
  describe('drag states', () => {
    it('shows active styling when active prop is true', () => {
      const { container } = renderWithDnd(
        <DropZone id="test-zone" type="row" label="Rows" active={true} currentVariables={[]} onRemove={vi.fn()} />,
      );

...
export const DesktopRecommendationBanner: React.FC<DesktopRecommendationBannerProps> = ({
  ...
  return (
    <div
      className="pointer-events-none fixed bottom-3 right-3 z-[var(--z-dropdown)] w-[min(92vw,640px)] rounded-lg border border-[var(--status-warning-border)] bg-[var(--status-warning-surface)] px-3 py-2 text-xs text-[var(--status-warning-text)] shadow-lg"
      role="status"
      aria-live="polite"

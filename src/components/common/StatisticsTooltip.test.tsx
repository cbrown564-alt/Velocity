...
describe('StatisticsTooltip', () => {
  ...
  it('renders Welch T-Test header', () => {
    render(<StatisticsTooltip stats={mockStats} sig="high_95" value={45.2} />);
  ...
  it('shows significantly lower message for low_95', () => {
    render(<StatisticsTooltip stats={mockStats} sig="low_95" value={45.2} />);
  ...
  it('shows moderately higher message for high_80', () => {
    render(<StatisticsTooltip stats={mockStats} sig="high_80" value={45.2} />);

    expect(screen.getByText('Moderately higher (80% confidence)')).toBeInTheDocument();
  });

  it('shows moderately lower message for low_80', () => {
    render(<StatisticsTooltip stats={mockStats} sig="low_80" value={45.2} />);
  ...
  it('shows not significant message when sig is undefined', () => {
    render(<StatisticsTooltip stats={mockStats} sig={undefined} value={45.2} />);
  ...
  it('formats very small p-values correctly', () => {
    ...
    render(<StatisticsTooltip stats={smallPValue} sig="high_95" value={45.2} />);

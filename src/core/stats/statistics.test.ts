...
describe('Statistics', () => {
  ...
  describe('calculateMeanCI', () => {
    ...
    it('calculates correct 80% CI for mean', () => {
      ...
      const ci = calculateMeanCI(10, 2, 100, 0.8);
  ...
  describe('calculatePairwiseComparisons', () => {
    ...
    it('detects significant differences between proportions', () => {
      ...
      const columns: ColumnStats[] = [
        { key: 'Col_A', proportion: 0.6, ess: 100 },
        { key: 'Col_B', proportion: 0.4, ess: 100 },
        { key: 'Col_C', proportion: 0.2, ess: 100 },
      ];
    ...
    it('respects significance alpha in pairwise comparisons', () => {
      ...
      const alpha20 = calculatePairwiseComparisons(columns, true, 0.2);
  ...
  describe('calculateDependentProportionsTest', () => {
    it('returns near-zero difference when both proportions are identical with full overlap', () => {
      const result = calculateDependentProportionsTest(0.5, 0.5, 0.5, 200);
    ...
    it('detects significance for large dependent proportion differences', () => {
      const result = calculateDependentProportionsTest(0.6, 0.3, 0.2, 300);
